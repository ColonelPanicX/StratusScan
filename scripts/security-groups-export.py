...
def get_security_group_rules(region):
    ...
    try:
        ...
        utils.log_error(f"Error getting security groups in AWS region {region}", e)
        return []
...
def main():
    ...
    try:
        ...
        # Ask user for AWS region selection
        ...
        if region_choice == "all":
            ...
            if is_valid_aws_region(region_choice):
                ...
                utils.log_info(f"Processing AWS region: {region_choice}")
            else:
