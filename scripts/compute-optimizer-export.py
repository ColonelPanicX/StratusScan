...
def get_ec2_recommendations(region):
    ...
    """
    print(f"\nFetching EC2 instance recommendations for region {region}...")
    recommendations = []
    ...
    try:
        ...
        print(f"Found {len(recommendations)} EC2 instance recommendations in {region}")
        return recommendations
    
    except Exception as e:
        print(f"Error getting EC2 recommendations in {region}: {e}")
        return []
...
def get_asg_recommendations(region):
    ...
    """
    print(f"\nFetching Auto Scaling Group recommendations for region {region}...")
    recommendations = []
    ...
    try:
        ...
        print(f"Found {len(recommendations)} Auto Scaling Group recommendations in {region}")
        return recommendations
    
    except Exception as e:
        print(f"Error getting ASG recommendations in {region}: {e}")
        return []
...
def get_ebs_recommendations(region):
    ...
    """
    print(f"\nFetching EBS volume recommendations for region {region}...")
    recommendations = []
    ...
    try:
        ...
        print(f"Found {len(recommendations)} EBS volume recommendations in {region}")
        return recommendations
    
    except Exception as e:
        print(f"Error getting EBS recommendations in {region}: {e}")
        return []
...
def get_lambda_recommendations(region):
    ...
    """
    print(f"\nFetching Lambda function recommendations for region {region}...")
    recommendations = []
    ...
    try:
        ...
        print(f"Found {len(recommendations)} Lambda function recommendations in {region}")
        return recommendations
    
    except Exception as e:
        print(f"Error getting Lambda recommendations in {region}: {e}")
        return []
...
def get_ecs_recommendations(region):
    ...
    """
    print(f"\nFetching ECS service recommendations for region {region}...")
    recommendations = []
    ...
    try:
        ...
        print(f"Found {len(recommendations)} ECS service recommendations in {region}")
        return recommendations
    
    except Exception as e:
        print(f"Error getting ECS recommendations in {region}: {e}")
        return []
