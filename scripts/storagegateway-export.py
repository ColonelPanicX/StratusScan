...
def main():
    ...
    # Get regions to scan
    utils.log_info("\nRegion Selection:")
    utils.log_info("1. Use default regions from config")
    utils.log_info("2. Scan all AWS regions")
    utils.log_info("3. Enter specific regions")
    ...
    if choice == '1':
        ...
        utils.log_error("Invalid choice. Using default regions.")
        regions = utils.get_default_regions()
